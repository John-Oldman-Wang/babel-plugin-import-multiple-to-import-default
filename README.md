# babel-plugin-import-named-to-import-default

Transforms named style imports:
...
```
npm install --save-dev babel-plugin-import-named-to-import-default
```
...
{
  "plugins": [
    ["import-named-to-import-default", {
      "my-library\/?(((\\w*)?\/?)*)": {
...
module: {
  rules: [{
    ...
    use: {
      ...
      query: {
        plugins: [
          [require('babel-plugin-import-named-to-import-default'), {
            'my-library': {
